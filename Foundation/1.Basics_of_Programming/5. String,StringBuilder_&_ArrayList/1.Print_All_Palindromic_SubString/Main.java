...
public class Main {
    public static boolean isPalindrome(String s){
        ...
        while(lo < hi){  // = isiliye nhi lgaya kyunki = sirf odd length ke case me jaayega aur age saari string palindromic h to bich wala char to check krne ki jrurat hi nhi hai.
